...
---
In this project, you will apply creative 3D production workflows to develop a 30 second animation. You will pursue your own interests while solving for the project's theme.
...
2. **Final Submission**
   - Requirements:
     - Upload .mp4 video file in compressed H.264 format to [Vimeo.com](http://Vimeo.com)
   - `.txt` file containing
     - Link to [Vimeo.com](http://Vimeo.com) video (Do not use Youtube please)
