...
2. Upload final materials as a `LASTNAME-project1-files.zip` file
    1. Include final work statement
        - MS Word .doc format
        - 150 words minimum
    2. file name: `LASTNAME-project1-statement.doc`
    3. Include the media you created
...
4. Go through the **project development process** (_See downloads for diagram image_):
    1. Pre-viz (references, sketch, research)
    2. Intention Statement 
    3. Production (model, texture, light, render) and post-production (color grade, export)
    4. Work Statement
