...
::iframe-component
---
src: https://youtube.com/embed/videoseries?list=PL-V2nChTadrXmwBV0kO-ErBLFnyWukKsD
title: Sculpture Garden Tutorial
---
::
...
2. Practice image composition techniques from art and design theory.
...
11. Save and import the images into Photoshop to adjust saturation, contrast.
    - PNG is fine, however rendering an EXR image and using the ‘HDR Toning’ feature in Photoshop will give the best results.
12. Save or export the image as `LASTNAME-pbr.png`, etc. in the project folder. Name the files in an organized in a logical way.
    - Do not submit an EXR as the final image, they are for image production process only.
