...
::iframe-component
---
src: https://youtube.com/embed/videoseries?list=PL-V2nChTadrUtPySfHyf4j_w6PGi6AES9
title: Modeling random objects Tutorial
---
::
...
4. Obtain three randomly generated objects from [this website](http://www.randomlists.com/things). Include a screenshot of the website objects in your project folder called `YOURNAME-objects-modeling.jpg` (or `.png`)
...
6. Create a new file for each object and save in the project folder.
    -  **Naming:** `YOURNAME-modeling-object1`, `YOURNAME-modeling-object2`, `YOURNAME-modeling-object2`
