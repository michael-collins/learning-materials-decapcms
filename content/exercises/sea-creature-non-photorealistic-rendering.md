...
::iframe-component
---
src: https://youtube.com/embed/videoseries?list=PL-V2nChTadrWh22nK2hfnGbeEaxMp3s_e
title: Sea creature: Non-photorealistic rendering Tutorial
---
::
...
1. Become familiarized rendering workflows for non-photorealistic rendering (NPR)
2. Gain understanding of lighting and materials for NPR
...
8. Compress the project folder once you’ve completed the tutorial and rename it `LASTNAME-npr-creature.zip`.
