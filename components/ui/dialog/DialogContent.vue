...
interface DialogContentDefaultProps extends DialogContentProps {
...
const props = defineProps<DialogContentDefaultProps>()
  ...
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="cn(
        ...
        'max-w-[calc(100vw-2rem)] p-4 rounded-lg sm:max-w-lg sm:p-6',
        props.class,
      )"
    >
      <slot />
